...
var projectsDiv = document.body.getElementsByClassName('projects')[0], 
    ...
    landingDownArrow = document.body.getElementsByClassName('fa-caret-down')[0];
...
var style = {
  ...
  fontColor: 'white', 
  numPortfolioColumns: (width < 769)? 1: 4
};
...
window.onresize = function() {
  ...
  style.numPortfolioColumns = (width < 769)? 1: 4;
  portfolioItem.style.width = 100 / style.numPortfolioColumns + '%';
  projectsDiv.innerHTML = '';
  createPortfolio();
};

landingDownArrow.onclick = function() {
  zenscroll.center(projectsDiv);
}
